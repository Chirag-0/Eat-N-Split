 ...
 return(
   <div className="app">
      <div className="sidebar">
        <FriendList friends={friends} selectedFriend={selectedFriend} onSelect={handleSelection}/>
        {showText && <FormAddFriend onAddFriend={handleAddFriend}/>}
        <Button onClick={handleSetText}>{showText ? 'Close' : 'Add friend'}</Button>
      </div>
...
function FormSplitBill({selectedFriend,onSplitBill}){
  ...
  const paidByFriend = bill ? bill - paidByUser : ''; // This is derived state
